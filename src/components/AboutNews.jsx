          ...
          <div className="relative">
            ...
            <div className="bg-[#00120a] border border-[#00ff4c]/30 rounded-xl p-6 shadow-lg shadow-[#00ff4c]/10 backdrop-blur-sm">
              <div className="flex items-center justify-center mb-4">
                <div className="w-2 h-2 bg-[#00ff4c] rounded-full mr-3 animate-pulse"></div>
                <h2 className="text-4xl font-sans font-bold text-[#00ff4c]">Image Gallery</h2>
                <div className="w-2 h-2 bg-[#00ff4c] rounded-full ml-3 animate-pulse"></div>
              </div>
