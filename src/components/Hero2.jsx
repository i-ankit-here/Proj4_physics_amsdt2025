        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 items-center mt-[100px] max-w-7xl mx-auto lg:px-8 px-3 mt-[80px] lg:mt-[2px]">
          <div className="flex flex-col items-center md:items-start justify-center z-20 py-4 gap-3">
            ...
            <h3 className="text-[#00ff4c] mx-auto md:mx-0 font-medium text-center md:text-left tracking-wide lg:text-xl">
              Where Sustainability and Science Fuse for a Smarter Future
            </h3>
          ...
          <div className="hidden md:flex justify-center items-center">
            {/* Placeholder for molecular structure graphic */}
            <div className="w-80 h-80 relative">
              {/* This would be replaced with an actual SVG or image of the molecular structure */}
              <div className="absolute w-full h-full flex items-center justify-center">
                <div className="w-24 h-24 border-2 border-[#00ff4c] rounded-full"></div>
                {/* Additional elements to represent the molecular structure could be added here */}
              </div>
            </div>
          </div>
        </div>
