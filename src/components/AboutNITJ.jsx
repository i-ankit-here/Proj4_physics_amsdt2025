...
function AboutNITJ(props) {
    ...
    return (
        <div className="bg-white container flex flex-col items-center lg:flex-row lg:justify-between lg:items-start max-w-7xl px-4 sm:px-10 lg:px-8 mx-auto py-16 min-h-[280px]">
            <div className="w-full md:w-[700px] px-4 lg:w-3/5 lg:max-w-full">
                ...
                <div className="bg-[white] border border-[#2563eb]/30 rounded-xl p-6 shadow-md hover:shadow-lg hover:shadow-[#2563eb]/20 transition-all duration-300">
                    {isLoading ? (
                        ...
                        <div className="text-base text-justify font-sans font-base text-white">
            ...
            <div className="w-full md:w-[700px] lg:w-2/5 lg:max-w-[450px] px-4 mt-10 lg:mt-0 mx-auto lg:px-5">
                ...
                <div className="bg-[white] border border-[#2563eb]/30 rounded-xl p-6 shadow-md hover:shadow-lg hover:shadow-[#2563eb]/20 transition-all duration-300 relative overflow-hidden">
                    ...
                    {isLoading ? (
                        ...
                        <div className="text-base text-justify font-sans font-base text-gray-700">
